CREATE DATABASE  IF NOT EXISTS `icecream_db` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `icecream_db`;
...
/*!40014 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0 */;icecreamstoreFlavorsQuantitiesPrice
